...
export const addCourse = createAction("[Course] Add Course", props<{course : FormData}>());
...
export const updateCourse = createAction("[Course] Update Course", props<{course : FormData}>());
